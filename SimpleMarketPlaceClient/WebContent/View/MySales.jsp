<%@page import="modelclasses.Sellinghistory"%>
<%@page import="modelclasses.Order"%>
   ...
   <div class="container">
      ...
      <aside>
         ...
         <ul class="categories">
           ...
           <%--  <% if(request.getAttribute("ordertotal")  != null && request.getAttribute("ordertotal") != ""  ) {%>
                      <li><span> <h4>Grand Total: $ <%= request.getAttribute("ordertotal") %></h4></span></li>
      ...
      <section id="content">
         ...
         <div class="inside">
            <h2> <span> Sales History</span></h2>
            <ul class="list">

               <% if(request.getAttribute("Sales") != null){
					Sellinghistory[] sale =  (Sellinghistory[]) request.getAttribute("Sales");
					// print the information about every category of the list
					for(int i =0;i<sale.length;i++) {%>
                            
                                    <li class="table" ><span></span>
                                       <h4><%= sale[i].getSellproname() %></h4>

                                       <table>
                                          
                                          <tr>
                                             <td>
                                                Price : $ <%= sale[i].getSellproprice() %>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                Quantity : <%= sale[i].getSellproqty() %>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                <h5>Buyer : <%= sale[i].getBuyer() %></h5>
                                             </td>
                                          </tr>
                                       </table>
                     ...
                     <% } %>
               <% } else { %>
                  <h2> <span><h4>No Sale(s)</h4></span></h2>
                <% } %>
