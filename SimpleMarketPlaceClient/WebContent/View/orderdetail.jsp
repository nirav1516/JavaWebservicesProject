...
<div class="wrap">
   ...
   <div class="container">
      ...
      <section id="content">
         ...
         <div class="inside">
            <h2> <span>Purchase History</span></h2>
            <ul class="list">
               ...
               <% if(request.getAttribute("orderdata") != null){
					...
					for(int i =0;i<orderdata.length;i++) {%>
                                    ...
                                    <li class="table"><span></span>
                                       <h4><%= orderdata[i].getOrproname() %></h4>

                                       <table>
                                          
                                          <tr>
                                             <td>
                                                Price : $ <%= orderdata[i].getOrproprice() %>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                Quantity : <%= orderdata[i].getOrqty() %>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                Total : <%= orderdata[i].getOrtotal() %>
                                             </td>
                                          </tr>
                                       </table>
                     ...
                     <% } %>
               <% } else { %>
                  <h2> <span><h4>No Past Order(s)</h4></span></h2>
                <% } %>
